...
public class PaymentStatementServiceImpl implements PaymentStatementService {
    ...
    public String generateStatementHtml(UUID rentCycleId) {
        ...
        if (rentCycle.getStatus() == com.livic.services.finance.domain.RentCycleStatus.PENDING) {
        ...
        com.livic.services.property.dto.UnitSummaryDTO unit = unitFacade.getUnitById(unitId).orElse(null);
