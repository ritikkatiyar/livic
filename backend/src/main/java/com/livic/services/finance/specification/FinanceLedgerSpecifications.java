package com.livic.services.finance.specification;
...
public class FinanceLedgerSpecifications {
    ...
    public static Specification<FinanceLedgerTbl> hasPropertyId(UUID propertyId) {
        return (root, query, cb) -> {
            ...
            jakarta.persistence.criteria.Root<com.livic.services.property.domain.UnitTbl> unitRoot = subquery.from(com.livic.services.property.domain.UnitTbl.class);
